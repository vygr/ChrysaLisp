...
@start /b .\obj\x86_64\WIN64\Windows\main_tui.exe .\obj\x86_64\WIN64\sys\boot_image -l 000-001 -l 000-002 -l 000-003 -l 000-004 -l 000-005 -l 000-006 -l 000-007 -l 000-008 -l 000-009 -run apps/tui/install.lisp
