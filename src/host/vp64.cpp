...
int vp64(uint8_t* data, int64_t *stack, int64_t* argv, int64_t* host_os_funcs, int64_t* host_gui_funcs, int64_t* host_audio_funcs, int64_t* host_gl_funcs)
{
	int64_t regs[16];
	int16_t* pc;
	int64_t ir;
