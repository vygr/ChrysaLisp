...
const uint8_t scan_code_to_hid_table[] =
{
    ...
    0x4A, // 0x47: Home (Note 1)

    0x52, // 0x48: Up Arrow (Note 1)
    0x4B, // 0x49: Page Up (Note 1)
    0x56, // 0x4A: Keypad -
    0x50, // 0x4B: Left Arrow (Note 1)
    0x5D, // 0x4C: Keypad 5
    0x4F, // 0x4D: Right Arrow (Note 1)
    0x57, // 0x4E: Keypad +
    0x4D, // 0x4F: End (Note 1)

    0x51, // 0x50: Down Arrow (Note 1)
    0x4E, // 0x51: Page Down (Note 1)
    0x49, // 0x52: Insert (Note 1)
    0x4C, // 0x53: Delete (Note 1)
    0x00, // 0x54: Nul
    0x00, // 0x55: Nul
    0x64, // 0x56: Europe 2 (Note 2)
    0x44, // 0x57: F11
