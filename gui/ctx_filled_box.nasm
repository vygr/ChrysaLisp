...
%include 'inc/sdl2.inc'
	...
	fn_function gui/ctx_filled_box
		...
		vp_cpy_ui r8, [r4 + local_rect + sdl_rect_x]
		vp_cpy_ui r9, [r4 + local_rect + sdl_rect_y]
		vp_cpy_ui r10, [r4 + local_rect + sdl_rect_w]
		vp_cpy_ui r11, [r4 + local_rect + sdl_rect_h]
