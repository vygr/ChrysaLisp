...
%include 'inc/sdl2.inc'
	...
	fn_function gui/ctx_filled_box
		...
		vp_cpy r8d, [r4 + local_rect + sdl_rect_x]
		vp_cpy r9d, [r4 + local_rect + sdl_rect_y]
		vp_cpy r10d, [r4 + local_rect + sdl_rect_w]
		vp_cpy r11d, [r4 + local_rect + sdl_rect_h]
		...
		loop_start
			...
			vp_sub r8, r10
			vp_sub r9, r11
			vp_cpy r8d, [r4 + local_clip_rect + sdl_rect_x]
			vp_cpy r9d, [r4 + local_clip_rect + sdl_rect_y]
			vp_cpy r10d, [r4 + local_clip_rect + sdl_rect_w]
			vp_cpy r11d, [r4 + local_clip_rect + sdl_rect_h]
