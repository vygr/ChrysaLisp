...
register declarations by use of 2 `(assign)` calls. The register list provided
here is auto assigned from and to the declared register input and output lists
