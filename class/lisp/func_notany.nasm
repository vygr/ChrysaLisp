...
%include 'class/class_lisp.inc'
	...
	def_function class/lisp/func_notany
		;inputs
		;r0 = lisp object
		;r1 = args
		;outputs
		...
		if {length >= 2}
			...
			error:
				...
				static_call error, create, {"(notany func list ...) not all lists", args}, {value}
			endif
		else
			static_call error, create, {"(notany func list ...) not enough args", args}, {value}
		endif
