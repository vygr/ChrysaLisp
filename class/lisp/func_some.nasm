...
def_func class/lisp/func_some
	...
	if {length >= 2}
		...
		ifnot {iter}
			...
			func_call error, create, {"(some func list ...) not all lists", args}, {value}
		endif
	else
		func_call error, create, {"(some func list ...) not enough args", args}, {value}
	endif
