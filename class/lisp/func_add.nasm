...
def_func class/lisp/func_add
	...
	if {length > 1}
		...
		error:
			func_call error, create, {"(add val val ...) vals are not all numbers", args}, {value}
		endif
	else
		func_call error, create, {"(add val val ...) not enough args", args}, {value}
	endif
