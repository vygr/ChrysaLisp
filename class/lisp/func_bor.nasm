...
def_func class/lisp/func_bor
	...
	if {length > 1}
		...
		error:
			func_call error, create, {"(bit-or val val ...) vals are not all numbers", args}, {value}
		endif
	else
		func_call error, create, {"(bit-or val val ...) not enough args", args}, {value}
	endif
