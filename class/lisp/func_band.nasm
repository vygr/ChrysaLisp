...
def_func class/lisp/func_band
	...
	if {length > 1}
		...
		error:
			func_call error, create, {"(bit-and val val ...) vals are not all numbers", args}, {value}
		endif
	else
		func_call error, create, {"(bit-and val val ...) not enough args", args}, {value}
	endif
