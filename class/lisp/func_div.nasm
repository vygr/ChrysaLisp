...
def_func class/lisp/func_div
	...
	vpif {length > 1}
		...
		error:
			func_call error, create, {"(div val val ...) vals are not all numbers", args}, {value}
		endif
	else
		func_call error, create, {"(div val val ...) not enough args", args}, {value}
	endif
