...
(ui-window *window* ()
	...
	(ui-grid _ (:grid_height 1)
		(ui-hchart net_regs_chart "Net Regs (bops/s)" +scale_size +bops (:color +argb_green))
		(ui-hchart net_memory_chart "Net Memory (bops/s)" +scale_size +bops (:color +argb_yellow))
		(ui-hchart net_reals_chart "Net Reals (mops/s)" +scale_size +mops (:color +argb_red)))
	(ui-grid _ (:grid_height 1)
		(ui-hchart regs_chart "Regs (bops/s)" +scale_size +bops (:color +argb_green))
		(ui-hchart memory_chart "Memory (bops/s)" +scale_size +bops (:color +argb_yellow))
		(ui-hchart reals_chart "Reals (mops/s)" +scale_size +mops (:color +argb_red))))
