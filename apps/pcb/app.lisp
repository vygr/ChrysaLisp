		...
		(ui-element _ (create-flow) ('flow_flags (logior flow_flag_right flow_flag_fillh))
			(each (lambda (l)
				(component-connect (ui-element __ (create-button)
					('text l 'color toolbar_col 'font (create-font-ctf "fonts/Entypo.ctf" 32))) (+ event_win_prev _)))
						'("" "" "" "" "" ""))
			(each (lambda (l)
				(component-connect (ui-element __ (create-button)
					('text l 'color toolbar2_col 'font (create-font-ctf "fonts/OpenSans-Regular.ctf" 24))) (+ event_win_show_all _)))
						'("0" "1" "2" "3" "4")))
