...
(defun redraw ()
	...
	(fpoly 0xff0ff0ff 0 (transform
		(points-stroke-polylines stack (fmul canvas_width 0.05) eps join-bevel cap-square cap-square
			(list (points-gen-quadratic stack
	...
	(fpoly argb_yellow 0 (defq p (transform
		(points-stroke-polygons stack (fmul canvas_width 0.011) eps join-miter
			(points-stroke-polylines stack (fmul canvas_width 0.033) eps join-bevel cap-round cap-arrow
				(list (points-gen-cubic stack
