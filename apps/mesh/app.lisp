...
(defun reset ()
	...
	(defq capsule_mesh (Mesh-iso (Iso-capsule 20 20 20) (f2r 0.25))
		sphere_obj (Scene-object (Mesh-iso (Iso-sphere 20 20 20) (f2r 0.25)) (fixeds 1.0 1.0 1.0) "sphere1")
		capsule1_obj (Scene-object capsule_mesh (fixeds 1.0 0.0 0.0) "capsule1")
		capsule2_obj (Scene-object capsule_mesh (fixeds 0.0 1.0 1.0) "capsule2")
		cube_obj (Scene-object (Mesh-iso (Iso-cube 8 8 8) (f2r 0.45)) (fixeds 1.0 1.0 0.0) "cube")
		torus_obj (Scene-object (Mesh-torus +real_1 +real_1/3 20) (fixeds 0.0 1.0 0.0) "torus1")
		sphere2_obj (Scene-object (Mesh-sphere +real_1/2 8) (fixeds 1.0 0.0 1.0) "sphere2"))
