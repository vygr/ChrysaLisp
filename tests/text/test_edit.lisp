...
; Perform wrap explicitly since low-level find_next does not wrap automatically
(unless (edit-find-next) (edit-top) (edit-find-next))
(assert-eq "Focus find 4 (wrap)" 1 (edit-cy))
...
; Test edit-filter-cursors (bridge find to cursors in focus)
(edit-find "Line")
(edit-cursors)
(edit-filter-cursors)
